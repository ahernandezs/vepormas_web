...
describe('InvestmentsCtrl', function() {
  var investmentsCtrl, scope, rootScope, http;
  ...
  beforeEach(inject(function($controller, $rootScope, $httpBackend) {
    ...
    rootScope = $rootScope;
    http = $httpBackend;
    investmentsCtrl = $controller('InvestmentsCtrl', {
      $scope: scope
    });
    scope.selectedAcccountId = "0050568032C41EE4A5D944DD0A211379-INV";
    scope.searchParams = {
